...
export const translations = {
  it: {
    ...
    hero: {
      ...
      hintPrinting: 'DECODIFICA IN CORSO…',
      hintDone: 'ACCESS_GRANTED · CV DISPONIBILE',
      shapeLabels: ['TERMINALE_POS', 'CODICE', 'EURO_FISCALE', 'AI_CORE', 'CV_FILE'],
      cvBtn: '⬇ SCARICA_CV.PDF',
    },
    skills: {
      heading: 'Competenze',
      cells: {
  ...
  en: {
    ...
    hero: {
      ...
      hintPrinting: 'DECRYPTING…',
      hintDone: 'ACCESS_GRANTED · CV READY',
      shapeLabels: ['POS_TERMINAL', 'CODE', 'FISCAL_EURO', 'AI_CORE', 'CV_FILE'],
      cvBtn: '⬇ DOWNLOAD_CV.PDF',
    },
    skills: {
      heading: 'Skills',
      cells: {
  ...
  ro: {
    ...
    hero: {
      ...
      hintPrinting: 'SE DECODEAZĂ…',
      hintDone: 'ACCESS_GRANTED · CV DISPONIBIL',
      shapeLabels: ['TERMINAL_POS', 'COD', 'EURO_FISCAL', 'AI_CORE', 'CV_FILE'],
      cvBtn: '⬇ DESCARCĂ_CV.PDF',
    },
    skills: {
      heading: 'Competențe',
      cells: {
